...
custom_entities_module = importlib.import_module("custom_entities")

# Access `label` dynamically
label = getattr(custom_entities_module, "label", None)
    ...
    try:
        ...
        for ent in doc.ents:
            ...
            spacy_entity_mapping[placeholder] = {
                ...
                "Custom Entity" if ent_label.startswith(label) else
